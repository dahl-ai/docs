...
<CardGroup cols={2}>
  ...
  <Card title="Get API key" icon="key" href="https://inference.dahl.global/#models">
...
1. **Get a token** — `POST https://inference.dahl.global/tokens` or use [inference.dahl.global/#models](https://inference.dahl.global/#models).
